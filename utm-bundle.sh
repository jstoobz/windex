...
# utm-bundle.sh — Build a ready-to-go USB drive for PC provisioning
#
...
#
# Usage:
#   utm-bundle.sh /Volumes/PROVISION [--username=user] [--password=Pass123] [--authkey=tskey-auth-xxx]
...
@echo off
:: ============================================================================
:: SETUP.bat - PC Provisioning Launcher
:: ============================================================================
...
echo ""
echo "  Ready to plug into the PC and double-click SETUP.bat"
echo "============================================================"
